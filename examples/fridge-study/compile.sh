...
typst compile --features bundle --format bundle --root . examples/fridge-study/main.typ
typst compile --features bundle --format bundle --root . --input mode=tracked examples/fridge-study/main.typ

echo "manuscript.pdf, response.pdf, manuscript-tracked.pdf, response-tracked.pdf ready in examples/fridge-study/main/"
